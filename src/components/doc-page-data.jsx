export const searchingAlgo=()=>{
    return [
      {
        "name": "Binary Search",
        "description": "Binary Search is a divide-and-conquer search algorithm that efficiently finds a target value within a sorted array. It works by repeatedly dividing the search range in half.",
        "advantages": [
      ...
      },
      {
        ...
        "implementationDetails": {
          "iterative": {
            "description": "Linear Search can be implemented iteratively using a loop.",
            "codeSnippet": "// Iterative Linear Search\n\nfunction linearSearch(arr, target) {\n  for (let i = 0; i < arr.length; i++) {\n    if (arr[i] === target) return i; // Found\n  }\n\n  return -1; // Not found\n}"
          }
        }
      },
      {
        "name": "Jump Search",
        "description": "Jump Search is a searching algorithm for ordered lists. It jumps ahead by fixed steps and then performs linear search in the identified block.",
        "advantages": [
          "Efficient for large datasets",
        ...
        "implementationDetails": {
          "iterative": {
            ...
            "codeSnippet": "// Iterative Jump Search\n\nfunction jumpSearch(arr, target) {\n  const n = arr.length;\n  const step = Math.floor(Math.sqrt(n));\n  let prev = 0;\n\n  while (arr[Math.min(step, n) - 1] < target) {\n    prev = step;\n    step += Math.floor(Math.sqrt(n));\n    if (prev >= n) return -1; // Not found\n  }\n\n  // Perform linear search in the identified block\n  for (let i = prev; i < Math.min(step, n); i++) {\n    if (arr[i] === target) return i; // Found\n  }\n\n  return -1; // Not found\n}"
          }
        }
      },
      {
        "name": "Exponential Search",
        "description": "Exponential Search is a searching algorithm that works on sorted arrays. It involves two steps: finding a range where the element may be present and performing binary search in that range.",
        "advantages": [
        ...
        "implementationDetails": {
          "iterative": {
            ...
            "codeSnippet": "// Iterative Exponential Search\n\nfunction exponentialSearch(arr, target) {\n  const n = arr.length;\n\n  if (arr[0] === target) return 0; // Found at the first element\n\n  let i = 1;\n  while (i < n && arr[i] <= target) {\n    i *= 2;\n  }\n\n  return binarySearch(arr, target, i / 2, Math.min(i, n)); // Perform binary search in the identified range\n}"
          }
        }
      },
      {
        "name": "Breadth-First Search (BFS)",
        "description": "BFS is a graph traversal algorithm that explores all the vertices of a graph in breadth-first order, visiting all neighbors of a vertex before moving on to the next level of neighbors.",
        "advantages": [
        ...
        "description": "DFS is a graph traversal algorithm that explores all the vertices of a graph in depth-first order, visiting a vertex and then recursively visiting its adjacent vertices.",
        "advantages": [
        ...
        "implementationDetails": {
        "algorithm": {
        "description": "DFS can be implemented using recursion or a stack data structure.",
        ...
        "description": "Dijkstra's Algorithm is a graph algorithm that finds the shortest path between nodes in a weighted graph. It works by maintaining a set of vertices whose shortest distance from the source is known.",
        "advantages": [
        ...
        "implementationDetails": {
        "algorithm": {
        "description": "Dijkstra's Algorithm can be implemented using a priority queue or a min heap.",
