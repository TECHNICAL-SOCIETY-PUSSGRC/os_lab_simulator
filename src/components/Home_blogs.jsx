...
const Home_blogs = () => {
  ...
  <button class="button-81" role="button"><a href="https://www.fusion-reactor.com/blog/multithreading-and-multiprocessing/#:~:text=A%20multiprocessing%20system%20has%20more,runs%20parallel%20to%20each%20other." target='_blank' >Read More</a></button>
  ...
  <img src={blog2} alt="blog img" />
    ...
    <p className='blog_content'>Microcontrollers and microprocessors are different ways of organizing and optimizing a...</p>
      ...
      <button class="button-81" role="button">    <a href="https://www.fusion-reactor.com/blog/multithreading-and-multiprocessing/#:~:text=A%20multiprocessing%20system%20has%20more,runs%20parallel%20to%20each%20other."target='_blank' >Read More</a>
</button>
    </div>
  </article>
